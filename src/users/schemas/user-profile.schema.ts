...
@Prop({ type: [String], default: [] }) whatWeDid?: string[];
@Prop({ type: Socials }) socials?: Socials;
@Prop({ type: [Types.ObjectId], default: [] }) caseOrder?: Types.ObjectId[];
@Prop({ type: Date, default: () => new Date() }) memberSince!: Date;
}
